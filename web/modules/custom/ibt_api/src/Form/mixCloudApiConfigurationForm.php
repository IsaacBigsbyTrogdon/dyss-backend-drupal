 ...
 */
class mixCloudApiConfigurationForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state, Request $request = NULL) {
    ...
    $form['ibt_api'] = array(
      '#type'  => 'fieldset',
      '#title' => $this->t('mixcloudApi settings'),
    );
    $form['ibt_api']['url'] = array(
      '#type'          => 'textfield',
      '#title'         => $this->t('mixcloudApi API URL'),
      '#default_value' => $config->get('ibt_api.url'),
    );
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $config = $this->config('ibt_api.settings');
    $state  = \Drupal::state();
    $config->set('ibt_api.url', $values['url']);
    $config->set('ibt_api.username', $values['username']);
    $config->set('ibt_api.public_key', $values['public_key']);
    $config->set('ibt_api.division', $values['division']);
    $config->set('ibt_api.territory', $values['territory']);
    $config->save();
